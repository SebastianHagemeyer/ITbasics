  ...
  var DOCS = [
    ...
    },
    {
      ...
      items: [
        ...
        { sig: 'game.submit_score(points)', desc: "Give your game its own leaderboard in the Game Gallery. When someone plays your published game, this saves their best score. Call it when the run ends, right before game_over. In the Sandbox it quietly does nothing.", ex: 'game.submit_score(score)\ngame.game_over("Score: " + str(score))' },
